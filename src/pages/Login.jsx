...
const Login = () => {
  ...
  return (
    ...
    <div className='w-full h-screen '>
          <img className='hidden sm:block absolute w-full h-full object-cover' src="https://r4.wallpaperflare.com/wallpaper/87/313/242/cyberpunk-edgerunners-anime-girls-anime-lucy-edgerunners-david-edgerunners-hd-wallpaper-d451619cf2096cabbec09f87fbb69c70.jpg" alt="/" />
            ...
            <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
              <div className='max-w-[320px] mx-auto py-16'>
                ...
                <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                  ...
                  <p className='py-8'><span className='text-gray-600'>Are you new to Netflix?</span>{' '}<Link to = '/signup'>Sign Up</Link></p>
                </form>
              </div>
